  ...
  <br>
    ...
    <el-col :span="17">
      <el-card :body-style="{ padding: '0px' }"  style="width:800px">
          <h2>READ MORE,READ MORE</h2>
           <img src="../images/moredetails.jpg" class="image">
       ...
       LTE was first proposed in 2004 by Japan's NTT DoCoMo, with studies on the standard officially commenced in 2005.[8] In May 2007, the LTE/SAE Trial Initiative (LSTI) alliance was founded as a global collaboration between vendors and operators with the goal of verifying and promoting the new standard in order to ensure the global introduction of the technology as quickly as possible.[9][10] The LTE standard was finalized in December 2008, and the first publicly available LTE service was launched by TeliaSonera in Oslo and Stockholm on December 14, 2009 as a data connection with a USB modem. The LTE services were launched by major North American carriers as well, with the Samsung SCH-r900 being the world’s first LTE Mobile phone starting on September 21, 2010[11][12] and Samsung Galaxy Indulge being the world’s first LTE smartphone starting on February 10, 2011[13][14] both offered by MetroPCS and HTC ThunderBolt offered by Verizon starting on March 17 being the second LTE smartphone to be sold commercially.[15][16] In Canada, Rogers Wireless was the first to launch LTE network on July 7, 2011 offering the Sierra Wireless AirCard 313U USB mobile broadband modem, known as the "LTE Rocket stick" then followed closely by mobile devices from both HTC and Samsung.[17] Initially, CDMA operators planned to upgrade to rival standards called UMB and WiMAX, but major CDMA operators (such as Verizon, Sprint and MetroPCS in the United States, Bell and Telus in Canada, au by KDDI in Japan, SK Telecom in South Korea and China Telecom/China Unicom in China) have announced instead they intend to migrate to LTE. The next versionof LTE is LTE Advanced, which was standardized in March 2011.[18] Services are expected to commence in 2013.[19] Additional evolution known as LTE Advanced Pro have been approved in year 2015.[20]
       </p>
           </div>
         </el-card>
    </el-col>

    <el-col :span="7" style="padding-top:150px">
    <div> <img src="../images/Capture.jpg" class="image">
    </div>
